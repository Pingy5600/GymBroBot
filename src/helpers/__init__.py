...
EXERCISE_CHOICES = [
    ...
    discord.app_commands.Choice(name="Incline Chest Press", value="incline-chest-press"),
]
...
EXERCISE_IMAGES = {
    ...
    "incline-chest-press": "https://fitnessprogramer.com/wp-content/uploads/2021/02/Incline-Chest-Press-Machine.gif"
}
