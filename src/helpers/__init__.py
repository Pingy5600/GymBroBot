...
EXERCISE_CHOICES = [
    ...
    discord.app_commands.Choice(name="Dumbell Curl", value="dumbell-curl"),
    discord.app_commands.Choice(name="Incline Dumbell Curl", value="incline-dumbell-curl"),
    ...
    discord.app_commands.Choice(name="Dumbell Lateral Raise", value="dumbell-lateral-raise"),
...
EXERCISE_IMAGES = {
    ...
    "dumbell-curl": "https://cdn-0.weighttraining.guide/wp-content/uploads/2022/06/Two-arm-dumbbell-curl.png?ezimgfmt=ng%3Awebp%2Fngcb4",
    "incline-dumbell-curl": "https://cdn-0.weighttraining.guide/wp-content/uploads/2022/02/Incline-dumbbell-inner-biceps-curl.png?ezimgfmt=ng%3Awebp%2Fngcb4",
    ...
    "dumbell-lateral-raise": "https://cdn-0.weighttraining.guide/wp-content/uploads/2016/05/dumbbell-lateral-raise-resized.png?ezimgfmt=ng%3Awebp%2Fngcb4",
